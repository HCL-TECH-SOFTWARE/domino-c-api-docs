...
<ul type="disc">
<li>HCL Domino or HCL Notes 14.5.1 for Windows. All Windows platforms supported by Notes 14.5.1 are also supported by this toolkit.
<li>Microsoft Visual Studio 2017/2022. </ul>
<br>
The following software is required to develop HCL C API programs for Domino:<br>

<ul type="disc">
<li>HCL Domino or HCL Notes 14.5.1 for Windows.  All Windows platforms supported by Domino 14.5.1 are also supported by this toolkit. 
<li>Microsoft Visual Studio 2017/2022. </ul>
<br>
<br>
...
<br>
HCL Domino and HCL Notes 14.5.1 support applications developed using the HCL C API Toolkit for Notes/Domino 14.5.1 as well as existing Domino and Notes Releases (providing that Release/Build environment is supported on the given Windows OS). <br>
<br>
