...
list.  The output is to be returned in the caller’s retpInfo struct.  
...
```
**See Also :**
[SECCreateTokenListEntry](D:/md_files/SECCreateTokenListEntry.md)
[SECTokenListFree](D:/md_files/SECTokenListFree.md)
