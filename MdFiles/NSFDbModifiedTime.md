...
**NSFDbModifiedTime** **- Get a
database's data/non-data last modified times.**
 ...
 **Sample Usage :**
   ...
   if (error\_status = NSFDbModifiedTime(db\_handle\_dst, &data\_td\_dst,  
