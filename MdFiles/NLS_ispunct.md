...
**NLS\_ispunct** **- Tests if
a character is a punctuation character.**
...
This
function tests if a character is a punctuation character.
...
(routine)  -  NLS\_SUCCESS - The specified character is a punctuation character.  

NLS\_PROPNOTFOUND - The specified character is NOT a punctuation character.  
