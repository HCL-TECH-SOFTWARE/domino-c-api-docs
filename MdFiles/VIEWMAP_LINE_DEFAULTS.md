...
**VIEWMAP\_LINE\_DEFAULTS** **-** Default
settings for lines in Navigators.
...
The
VIEWMAP\_LINE\_DEFAULTS structure contains default attributes for lines in the
