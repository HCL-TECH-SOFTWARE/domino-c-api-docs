...
**IDEntries** **- Returns
the number of note IDs in the specified ID Table.**
...
This
function takes a handle to an ID Table and returns the number of IDs in the ID
Table.
 ...
 **Sample Usage :**
               ...
               num\_entries = IDEntries(arctable\_handle);  

               printf("Analysis of Notes between begin &
end:\n");  
