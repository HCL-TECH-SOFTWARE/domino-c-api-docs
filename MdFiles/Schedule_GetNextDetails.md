...
**Schedule\_GetNextDetails** **- Returns a
handle to the next detail object for the schedule.**
...
STATUS
LNPUBLIC **Schedule\_GetNextDetails(**  
      ...
      SCHED\_DETAIL\_LIST FAR \* FAR \*retpNextDetail**);**
