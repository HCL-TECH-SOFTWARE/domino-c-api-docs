...
**ldap\_next\_reference** **- Get the
next reference in the list of references.**
...
LDAPMessage
\* LNPUBLIC **ldap\_next\_reference(**  
...
This
function gets the next reference in the list of references in a result chain
...
#define
ldap\_next\_reference(ld, chain)         ND\_ldap\_next\_reference((ld), (chain))
...
chain  -  The message returned by a previous call to ldap\_first\_reference or
...
nref =
ldap\_next\_reference(ld, chain);
