...
**NSFGetSummaryServerNamePtr** **- Returns
the server name for a specific entry in the replication history summary.**
...
char
FAR \* **NSFGetSummaryServerNamePtr(**  
...
This
function returns the server name for a specific entry in the replication
...
#define
NSFGetSummaryServerNamePtr(Summary, Index) \  
...
(routine)  -  A pointer to the server name component of a replication history
summary entry.  This pointer is NOT null terminated.  
