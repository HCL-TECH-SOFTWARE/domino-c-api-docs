...
**FontIsUnderline** **- Returns
TRUE if the specified FONTID has the UNDERLINE attribute set, FALSE otherwise.**
...
Tests to see
if the UNDERLINE attribute is set in the specified FONTID.  Implemented as a
macro:  
...
**[FontSetUnderline](FontSetUnderline.md)**
