...
**MIMEEntityContentID** **- get the
string for the Content-ID header; returns everything after the field name,
colon.**
...
const
char \* LNPUBLIC **MIMEEntityContentID(**  
...
This
function MIMEEntityContentID returns a pointer to the string value of the
...
if (error = MIMEOpenDirectory(hNote,
&hMIMEDir)) {
...
pszHeaderValue =
MIMEEntityContentID(pRootEntity);
