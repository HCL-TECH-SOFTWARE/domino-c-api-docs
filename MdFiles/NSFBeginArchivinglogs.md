...
**NSFBeginArchivingLogs** **- Initiate
...
STATUS
LNPUBLIC **NSFBeginArchivingLogs(**void**);**
...
Lock out
other processes trying to archive the log files and initiate the archiving of
transactional logs.
...
**[NSFEndArchivingLogs](NSFEndArchivingLogs.md)**
