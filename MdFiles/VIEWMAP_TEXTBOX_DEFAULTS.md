...
**VIEWMAP\_TEXTBOX\_DEFAULTS** **-** Default
settings for Navigator text boxes.
...
The
VIEWMAP\_TEXTBOX\_DEFAULTS structure contains default attributes for text boxes
in the Navigator.  This structure is a component of the VIEWMAP\_STYLE\_DEFAULTS
