...
**NOBLK** **- Extract
the status code flag values from the status code.**
...
The status
code flag values are extracted from the status code, and returned in a value of
type STATUS.
...
#define NOBLK(x) ((STATUS) ((x)&(STS\_DISPLAYED|STS\_REMOTE)))
