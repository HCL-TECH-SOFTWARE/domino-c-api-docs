...
The
function  MMGetInbLineLen returns the Conversions Controls 'inbound line
length' setting.
...
(routine)  -  if set, when converting MIME rich text parts to CD, justify using
...
**[MMSetInbLineLen](MMSetInbLineLen.md)**
