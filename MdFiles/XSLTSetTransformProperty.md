...
**XSLTSetTransformProperty** **- Set an
XSLT Transform Property Value**
...
STATUS
LNPUBLIC **XSLTSetTransformProperty(**  
...
This
function sets the XSLT Property Values defined in XSLT\_PROPERTY.  Call this
function for each property value to set.
...
prop  -   XSLT Property member to set, defined in XSLT\_PROPERTY  
