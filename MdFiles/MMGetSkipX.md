...
The
function  MMGetSkipX returns the Conversions Controls 'skip X-Notes-Item
headers' setting.
...
(routine)  -  if TRUE, don't export any headers named x-notes-item (default
FALSE)  
