...
**IDTableTime** **- Returns
the TIMEDATE structure that is stored in an ID Table.**
...
This
function returns the TIMEDATE structure that is stored in an ID Table.  This
...
(routine)  -  Returns the TIMEDATE structure that is stored in the specified ID
Table.  
