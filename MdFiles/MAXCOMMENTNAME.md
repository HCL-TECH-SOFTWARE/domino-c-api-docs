...
**MAXCOMMENTNAME** **-** Maximum
number of characters for the Comment parameter of the REG functions.
...
Maximum size
of the Comment string parameter of REGCross CertifyID, REGNewCertifier,
