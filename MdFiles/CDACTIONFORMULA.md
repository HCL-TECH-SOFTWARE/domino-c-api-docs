...
A
CDACTIONFORMULA record is stored in fields of type TYPE\_ACTION, usually the
...
Header             Defines
this composite data item as a CDACTIONFORMULA item.


dwFlags           Option
flags (see ACTIONFORMULA\_FLAG\_xxx).
...
**[ACTIONFORMULA\_FLAG\_xxx](ACTIONFORMULA_FLAG_xxx.md)**
