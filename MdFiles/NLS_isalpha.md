...
**NLS\_isalpha** **- Tests if
a character is an uppercase or lowercase alphabetic character.**
...
This
function tests if a character is an uppercase or lowercase alphabetic
character.
