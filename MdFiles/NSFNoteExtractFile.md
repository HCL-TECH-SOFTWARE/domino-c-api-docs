...
created in the current working directory.
   ...
   **Note:
NSFNoteExtractFile should be deprecated from Notes/Domino 8.0.1. The preferred
...
File names are accepted in LMBCS;  names are translated to the character set
used by the operating system when the new output file is created.  
