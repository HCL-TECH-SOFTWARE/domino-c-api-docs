...
**MIMEEntityIsMultiPart** **- test
input MIME entity to determine if it is a multipart content type.**
...
BOOL
LNPUBLIC **MIMEEntityIsMultiPart(**  
...
This
function MIMEEntityIsMultiPart returns TRUE if the input MIME entity is a
...
(routine)  -  TRUE if input MIME entity is a multipart entity with child
