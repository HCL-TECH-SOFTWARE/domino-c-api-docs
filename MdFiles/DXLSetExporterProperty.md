...
**DXLSetExporterProperty** **- Set DXL
exporter property**
...
STATUS
LNPUBLIC **DXLSetExporterProperty(**  
...
This
function sets the Export Property Values defined in DXL\_EXPORT\_PROPERTY.  Call
...
propValue  -  value to set the Export Property, values defined in
