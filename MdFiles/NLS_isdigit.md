...
This
function tests if a character is a numeric digit.
...
(routine)  -  NLS\_SUCCESS - The specified character is a numeric digit.  

NLS\_PROPNOTFOUND - The specified character is NOT a numeric digit.  
