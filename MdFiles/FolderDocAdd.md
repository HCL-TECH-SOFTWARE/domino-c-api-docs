...
This
function adds the document(s) specified in an ID Table from a folder.
...
/\* To add documents to
this folder, create an id table of docs \*/  
  ...
  if (error = IDInsert (hIDTable, Doc\_ID, NULL))  
  ...
  error =
FolderDocAdd (hDB, NULLHANDLE, FNoteID, hIDTable, 0L);  
