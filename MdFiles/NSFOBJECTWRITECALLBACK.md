...
**NSFOBJECTWRITECALLBACK** **-** Definition
of the object write callback function used from NSFDbGetNotes.
...
typedef STATUS
(LNCALLBACKPTR NSFOBJECTWRITECALLBACK) (
...
Buffer -
Buffer containing a "chunk" of the object (as this function will be
