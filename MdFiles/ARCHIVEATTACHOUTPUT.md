...
**ARCHIVEATTACHOUTPUT** **-** User-defined
function called by ArchiveExportDatabase that used to pass attachment data to
the implementor.
...
typedef STATUS
(LNCALLBACKPTR ARCHIVEATTACHOUTPUT)
...
Can be
called many times for each attachment.
...
- Size of Buffer.
                        ...
                        bLastBuffer
- TRUE when we are sending the last buffer.
