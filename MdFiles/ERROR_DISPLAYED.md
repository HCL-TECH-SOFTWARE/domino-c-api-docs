...
**ERROR\_DISPLAYED** **- Indicate
whether the STS\_DISPLAYED bit is set.**
...
define ERROR\_DISPLAYED(x)       ((x) & STS\_DISPLAYED)
...
code's STS\_DISPLAYED bit is set.  
