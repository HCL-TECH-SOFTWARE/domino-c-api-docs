...
**VIEWMAP\_TEXT\_RECORD** **-** Navigator
text graphic CD record.
...
The
VIEWMAP\_TEXT\_RECORD stores text to be displayed in a Navigator.  This record is
...
DRObj              Common
fields, including VIEWMAP\_TEXT\_RECORD signature.   See VMODSbigobj.
...
FillStyle            Style
for textbox fill.   Use VM\_FILL\_xxx value.
