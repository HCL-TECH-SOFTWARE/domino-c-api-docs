...
**ldap\_first\_message** **- Get the
first message in the list of messages.**
...
This
function gets the first message in the list of messages in a result chain
...
#define
ldap\_first\_message(ld, res)             ND\_ldap\_first\_message((ld), (res))
