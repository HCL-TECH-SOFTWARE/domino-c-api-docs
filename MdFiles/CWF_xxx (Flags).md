...
**CWF\_xxx (Flags)** **-** NSFNoteComputeWithForm
validation flag - dwFlags
 ...
 **Symbolic Values :**      CWF\_CONTINUE\_ON\_ERROR        -  Ignore error processing for
fields.  
...
If
CWF\_CONTINUE\_ON\_ERROR is specified in the dwFlags argument of the
