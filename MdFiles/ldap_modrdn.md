...
This
function will initiate an asynchronous ldap modify RDN operation.
...
#define
ldap\_modrdn(ld, dn, newrdn)            ND\_ldap\_modrdn((ld), (dn), (newrdn))
