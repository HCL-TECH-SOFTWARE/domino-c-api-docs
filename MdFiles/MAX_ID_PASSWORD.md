...
**Symbolic Value : Limits; User
Registration**



**MAX\_ID\_PASSWORD** **-** Maximum size
of a password string.
...
Maximum size
of a password string.  Used in registering a new certifier/workstation/server.
