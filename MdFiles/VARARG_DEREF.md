...
**VARARG\_DEREF** **- Deference
elements of a variable argument list.**
...
This
function is used to deference elements of a variable argument list of an API
function in a Extension Manager callback.  This function is implemented as a
macro.
