...
**FontIsStrikeOut** **- Returns
TRUE if the specified FONTID has the STRIKEOUT attribute set, FALSE otherwise.**
...
Tests to see
if the STRIKEOUT attribute is set in the specified FONTID.  Implemented as a
macro:  
...
**[FontClearStrikeOut](FontClearStrikeOut.md)**
