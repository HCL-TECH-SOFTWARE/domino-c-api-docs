...
**NSFDB2DeleteUsernamePW** **- Remove a
...
This function
will clear a DB2 username and password stored in a Notes ID file.
...
of the user ID to remove the user's DB2 username and password from.  NULL if
