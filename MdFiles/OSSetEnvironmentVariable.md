...
**OSSetEnvironmentVariable** **- Set an
...
void
LNPUBLIC **OSSetEnvironmentVariable(**  
...
is used to set a Domino or Notes environment variable to the value of the
specified string.   The specified environment variable can be existing or new.  
...
Value  -  Pointer to a text buffer containing the new value of the environment
variable as an null-terminated string.  
