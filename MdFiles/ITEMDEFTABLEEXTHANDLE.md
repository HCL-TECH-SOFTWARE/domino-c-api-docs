...
**ITEMDEFTABLEEXTHANDLE** **-** Handle to an
Item Definition Table  (Extended) for a database.
...
Handle to an
Item Definition Table for a database.  Use NSFDbItemDefTableExt to obtain this
handle.
