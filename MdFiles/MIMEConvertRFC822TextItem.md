...
**MIMEConvertRFC822TextItem** **- Convert a
...
STATUS
LNPUBLIC **MIMEConvertRFC822TextItem(**  
...
ASCIIZ string), and the length of the item name.
...
if (error =
MIMEConvertRFC822TextItem(hNote, MAIL\_POSTEDDATE\_ITEM,
