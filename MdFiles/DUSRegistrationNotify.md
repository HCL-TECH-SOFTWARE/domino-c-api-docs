...
**DUSRegistrationNotify** **- Notify
registration is about to begin or is complete.**
...
STATUS
LNCALLBACK **DUSRegistrationNotify(**  
...
Notifies the
DUS that Domino user registration for the user represented by UserName is about
to start or just finished.  This allows the DUS to take pre or post
registration action to supplement registration-releated activity.
