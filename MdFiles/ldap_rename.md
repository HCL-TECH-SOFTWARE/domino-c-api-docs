...
**ldap\_rename** **- Initiate
an asynchronous ldap modify DN operation.**
...
This
function initiates an asynchronous modify DN operation with controls.
...
#define
ldap\_rename(ld, dn, newrdn, newparent, deleteoldrdn, serverctrls, clientctrls,
msgid) \   

              ND\_ldap\_rename((ld), (dn), (newrdn), (newparent), (deleteoldrdn),
...
ldap\_rename(ld,
dn, newrdn, newparent, deleteoldrdn, serverctrls. clientctrls, msgid);
