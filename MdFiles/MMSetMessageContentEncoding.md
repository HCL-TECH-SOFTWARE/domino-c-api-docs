...
**MMSetMessageContentEncoding** **- set
...
void
LNPUBLIC **MMSetMessageContentEncoding(**  
...
The
function  MMSetMessageContentEncoding sets the Conversions Controls 'message
content encoding' setting to the input value, wMessageContentEncoding.  No
...
wMessageContentEncoding  -  the value to use for the Conversion Controls
...
MMSetMessageContentEncoding(hCC,
0);  /\* message content encoding \*/
...
**[MMGetMessageContentEncoding](MMGetMessageContentEncoding.md)**
