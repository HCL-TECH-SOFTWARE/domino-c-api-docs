...
**TimeExtractTicks** **- Extracts
the number of ticks since GMT midnight from a TIMEDATE value.**
...
This
function extracts the number of ticks since GMT midnight from a TIMEDATE
