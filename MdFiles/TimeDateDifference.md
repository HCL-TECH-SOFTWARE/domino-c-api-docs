...
**TimeDateDifference** **-
Difference between two TIMEDATE values.**
...
This
function returns a long integer value containing the difference in seconds
 ...
 **Sample Usage :**
   ...
   time\_delta = TimeDateDifference(&binary\_td2,&binary\_td1);     
...
**[TimeDateDifferenceFloat](TimeDateDifferenceFloat.md)**
