...
**ACLClearPriv** **- Clear a
bit in an ACL\_PRIVILEGES structure.**
...
This is a
macro that clears the given bit in an ACL\_PRIVILEGES structure.
...
Num  -  The bit number (0 through ACL\_PRIVCOUNT - 1) of the bit to be cleared.  
