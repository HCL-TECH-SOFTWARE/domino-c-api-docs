...
**VIEWMAP\_SHAPE\_DEFAULTS** **-** Default
settings for Navigator shapes.
...
The
VIEWMAP\_SHAPE\_DEFAULTS structure contains default attributes for shapes in the
