...
**NOTESAPICDECL** **-** \* OBSOLETE \*
"C" calling convention for Notes API Functions
...
This macro
defines the calling convention used for Notes API functions that have a
variable number of arguments.  Normally, this macro is only used in the API
...
\_Cdecl" calling convention.  Under Windows and OS/2 1.x, the calling
convention used is "FAR cdecl".  On other platforms, this macro is
...
Usage example:  
    ...
    AddInSetStatus (FORMAT\_RESOURCE,  
