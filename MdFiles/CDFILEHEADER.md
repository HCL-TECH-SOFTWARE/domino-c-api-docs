...
**CDFILEHEADER** **-** Structure
which defines a CSS header.
...
typedef struct{  
    ...
    DWORD   SegCount;              /\* Number of CDFILESEGMENT records expected
to follow \*/  
...
This
structure is used to define a Cascading Style Sheet (CSS) that is part of a
Domino database.  CDFILESEGMENT structure(s) follow the CDFILEHEADER.
...
Header -
Defines this composite data item as a CDFILEHEADER item.
...
A non-null
terminated variable length string follows. This string is the file extension
for the file. For example: "css".
...
**[CDFILESEGMENT](CDFILESEGMENT.md)**
