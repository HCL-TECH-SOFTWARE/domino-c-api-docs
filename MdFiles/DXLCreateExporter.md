...
This
function is called to initialize both the DXLEXPORTHANDLE and the
DXL\_EXPORT\_PROPERTY default values.  This function  must be the first function
...
prethDXLExport  -  A DXL Export Handle needed to pass to the other DXL Import
functions.  
...
**[DXLDeleteExporter](DXLDeleteExporter.md)**
