...
**CDLAYOUTEND** **-** Record
marking the end of a layout region.
...
The
CDLAYOUTEND record marks the end of the elements defining a layout region
...
Header                   Defines
this composite data item as a CDLAYOUTEND item.
