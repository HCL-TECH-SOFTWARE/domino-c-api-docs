...
**NLS\_isupper** **- Tests if
a character is an uppercase alphabetic character.**
...
This
function tests if a character is an uppercase alphabetic character.
...
(routine)  -  NLS\_SUCCESS - The specified character is an uppercase alphabetic
character.  

NLS\_PROPNOTFOUND - The specified character is NOT an uppercase alphabetic
character.  
