...
**NSFItemDefExtEntries** **- Get the
number of items from the extended version of the database's Item Definition
Table.**
...
This function
gets the number of items from the extended version of the database's Item
Definition Table.  This information is contained in the
ITEM\_DEFINITION\_TABLE\_EXT structure and  first use function
...
NumEntries  -  A pointer to the number of items or entries in the
ITEM\_DEFINITION\_TABLE\_EXT structure.  
