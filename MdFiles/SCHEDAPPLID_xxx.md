 ...
 **Symbolic Values :**      SCHEDAPPLID\_ORGANIZER2X       -  Lotus Organizer 2.x.  

  

      SCHEDAPPLID\_ORGANIZER4X       -  Lotus Organizer 4.x  

  

      SCHEDAPPLID\_OV              -  Improv.  
...
These are
application ID's for the SCHED\_LIST wApplicationID field.  This is used to
interpret the application specific UserAttr field in the SCHED\_ENTRIES
