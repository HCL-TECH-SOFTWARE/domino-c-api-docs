...
**MIMEGetNextSibling** **- Get the
next MIME entity at the current 'level'; e.g., the next alternative within a
...
This
function MIMEGetNextSibling returns a pointer to the next sibling entity; i.e.,
the next child entity of some parent multipart entity.  If there are no
