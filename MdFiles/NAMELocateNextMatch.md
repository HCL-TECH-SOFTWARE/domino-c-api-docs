...
void
far \* LNPUBLIC **NAMELocateNextMatch(**  
...
this function to iterate over multiple matches when a call to NAMELookup yields
more than one match for a given name.   
...
Use NAMELocateNextName to obtain this location.  
