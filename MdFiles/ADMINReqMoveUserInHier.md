...
**ADMINReqMoveUserInHier** **- Create a
"Move Person in Hierarchy" request.** 
...
STATUS
LNPUBLIC **ADMINReqMoveUserInHier(**  
...
This
function creates a "Move Person in Hierarchy" request in the
