...
**NLS\_isspace** **- Tests if
a character is a whitespace character.**
...
This
function tests if a character is a whitespace character.
...
(routine)  -  NLS\_SUCCESS - The specified character is a whitespace character.  

NLS\_PROPNOTFOUND - The specified character is NOT a whitespace character.  
